...
class SearchLearningUnitDto(object):
    ...
    def __init__(self, search_id=None, teaching_goals=None, required_skills=None, processing_time=None, rating=None, content_creator=None, content_provider=None, target_audience=None, semantic_density=None, semantic_gravity=None, content_tags=None, context_tags=None, link_to_help_material=None, title=None, language=None, description=None):  # noqa: E501
