...
class SkillRepositoryDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ownerId", "id", "name", "taxonomy", "description", "version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ownerId", "id", "name", "taxonomy", "description", "version", ], str]):
