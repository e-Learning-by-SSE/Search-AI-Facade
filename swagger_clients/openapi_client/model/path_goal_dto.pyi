...
class PathGoalDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "title", "requirements", "pathGoals", "targetAudience", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "title", "requirements", "pathGoals", "targetAudience", "description", ], str]):
