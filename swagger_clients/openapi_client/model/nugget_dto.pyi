...
class NuggetDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isTypeOf", "language", "processingTime", "id", "presenter", "mediatype", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isTypeOf", "language", "processingTime", "id", "presenter", "mediatype", ], str]):
