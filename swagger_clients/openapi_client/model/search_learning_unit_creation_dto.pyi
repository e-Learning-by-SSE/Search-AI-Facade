...
class SearchLearningUnitCreationDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "language", "processingTime", "rating", "contentCreator", "contentProvider", "targetAudience", "semanticDensity", "semanticGravity", "contentTags", "contextTags", "linkToHelpMaterial", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "language", "processingTime", "rating", "contentCreator", "contentProvider", "targetAudience", "semanticDensity", "semanticGravity", "contentTags", "contextTags", "linkToHelpMaterial", "description", ], str]):
