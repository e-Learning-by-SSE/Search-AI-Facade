...
class ResolvedSkillRepositoryDto(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "skills", "name", "taxonomy", "description", "version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "skills", "name", "taxonomy", "description", "version", ], str]):
