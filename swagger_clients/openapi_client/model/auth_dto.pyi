...
class AuthDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "name", "password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "name", "password", ], str]):
