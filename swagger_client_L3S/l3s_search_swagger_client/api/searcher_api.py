...
class SearcherApi(object):
    ...
    def post_dense_retrieval(self, body, **kwargs):  # noqa: E501
        ...
        :param DenseSearcherInput body: (required)
        :return: None
    ...
    def post_simple_search(self, body, **kwargs):  # noqa: E501
        """post_simple_search  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_simple_search(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_simple_search_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_simple_search_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_simple_search_with_http_info(self, body, **kwargs):  # noqa: E501
        """post_simple_search  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_simple_search_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_simple_search" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_simple_search`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/searcher/traditional-retrieval', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
